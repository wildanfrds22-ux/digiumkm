<x-guest-layout>
    <div class="mb-6 text-center">
        <h1 class="text-xl font-extrabold text-gray-900">Masuk ke Akun Anda</h1>
        <p class="text-gray-500 text-sm mt-1">Kelola strategi digitalisasi usaha Anda</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <div class="text-center mt-4 text-sm text-gray-600">
            Belum punya akun?
            <a href="{{ route('register') }}" class="text-brand-600 font-bold hover:underline">Daftar sekarang</a>
        </div>
    </form>
</x-guest-layout>
